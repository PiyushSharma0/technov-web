...
const Navbar = () => {
  ...
  return (
    <div
      className={`fixed top-7 w-[90%] shadow-[#1414141E]  shadow-l-[#1414141E] mx-10 bg-white shadow-xl rounded-2xl`}
    >
      <nav className="container relative flex flex-wrap items-center justify-between py-2 px-1 rounded-full mx-auto lg:justify-between xl:px-0">
        {/* Logo  */}
        <Disclosure>
          {({ open }) => (
            <>
              <div className="flex flex-wrap items-center px-4 justify-between w-full lg:w-auto">
                <Link href="/">
        ...
        <div className="hidden mr-6 space-x-4 lg:flex nav__item">
          <Link
            href="/signUp"
