...
export default function TopCard({number}) {
  //   const [i, setModal] = useRecoilState(modalState);
  //   const [j, setUserData] = useRecoilState(selectedUserState);
if(number==1){
  return (
    <div className="relative m-auto  p-2 w-full flex justify-center align-center flex-col bg-[#ffffff] shadow-[0_0_4px_rgba(50,69,107,0.2)] rounded-[6px] z-[1] overflow-hidden">
